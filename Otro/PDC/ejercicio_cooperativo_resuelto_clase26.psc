Algoritmo ejercicio_cooperativo_resuelto_clase26
	...
	Escribir "***********************************" 
	Escribir " estoy subiendo vídeos a youtube por si les sirve @aprendizarg3617"
	
	Escribir " por éste link sube las clases grabadas Jere"
	
	Escribir " https://drive.google.com/drive/u/2/folders/1oE1CDodhiL-fBLan-VH5zs_cvxpsdPnm" 
	Escribir "************************************"
	
	Escribir "Jocker pasá el código jjjjjjjj"
FinAlgoritmo
