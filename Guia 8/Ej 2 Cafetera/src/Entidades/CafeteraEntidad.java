...
public class CafeteraEntidad {
    ...
    public CafeteraEntidad(double capacidadMaxima, double cantidadActual) {
    ...
    public String toString() {
        return "CafeteraEntidad{" + "capacidadMaxima=" + capacidadMaxima + ", cantidadActual=" + cantidadActual + ", getCapacidadMaxima=" + getCapacidadMaxima + ", getCantidadActual=" + getCantidadActual + '}';
    }
